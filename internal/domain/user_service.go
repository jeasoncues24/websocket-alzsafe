...
func (us *UserService) CreateUser(ctx context.Context, username, passwordHash, email string, roleID *int64, empresaID *int64) (*AdminUser, error) {
...
// UpdateUser actualiza un usuario existente con protección de root
func (us *UserService) UpdateUser(ctx context.Context, userID int64, email *string, roleID *int64, activo *bool, empresaID *int64) (*AdminUser, error) {
...
func (us *UserService) PromoteToRoot(ctx context.Context, targetUserID int64, requestingUserID int64) error {
	...
	// 5. Actualizar usuario a root
	targetUser.RoleID = &rootRole.ID
	targetUser.IsRoot = true
