...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "motion-overlay-smooth fixed inset-0 z-50 bg-black/80",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "motion-sheet-smooth fixed z-50 gap-4 bg-background p-6 shadow-lg",
          side === "top" &&
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close asChild>
            <Button variant="ghost" size="icon" className="motion-transition absolute right-4 top-4">
              <X className="h-4 w-4" />
