...
- [x] [Review][Defer] InsecureSkipVerify:true en WS upgrade — permite CSWSH desde cualquier origen [backend/internal/http/admin.go] — deferred, pre-existente
- [x] [Review][Defer] StartSession fallo parcial puede dejar s.starting sin limpiar correctamente [backend/internal/whatsapp/service.go] — deferred, pre-existente
